...
try {
    $stmt = $pdo->prepare("SELECT ds.id, ds.page_num, ds.pos_x, ds.pos_y, s.name, s.stamp_text, s.font, s.font_size, s.color FROM document_stamps ds JOIN stamps s ON ds.stamp_id = s.id WHERE ds.document_id = :did");
